...
class ImageRaiderGrabber:
    ...
    def insertImageLinks(self, images):
        ...
        btn = self.driver.find_elements_by_xpath(
            '/html/body/div[4]/div/div/article/div/div[1]/form/span/input')[0]
        btn.click()
    ...
    def uploadLocalImage(self, img):
        ...
        input.send_keys(p_i)
        btn = self.driver.find_elements_by_xpath(
            '/html/body/div[4]/div/div/article/div/div[1]/span/form/input[3]')[0]
        btn.click()
                ...
                with open(path, 'r') as csvfile:
                    ...
                    for row in reader:
                        if filterLink(row['Discovered Page URL']):
                            console.subtask('Added {0}'.format(
                                row['Discovered Page URL']))
